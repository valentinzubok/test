<div class="pb-2 mb-4 border-bottom"><h1 class="fs-2">Обратная связь</h1></div>
...
<div class="position-relative">
      ...
      <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample">
       Уважаемые посетители нашего сайта!
			...
			<a href="https://t.me/klukvatopp" class="btn btn-primary"><i class="bi bi-telegram"></i> Telegram</a>    </p>
...
<div class="bg-primary-soft rounded-2 p-4 p-sm-5">
...
[attachments]
<div class="col-lg-12">
<input name="attachments[]" class="form-control" type="file" id="formFileMultiple" multiple>
</div>
[/attachments]
...
<div class="col-lg-12">
<button class="btn btn-primary" type="submit" name="send_btn">Отправить сообщение</button>
</div>
