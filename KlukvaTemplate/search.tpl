<div class="pb-2 mb-4 border-bottom"><h1 class="fs-2">Поиск по сайту</h1></div>
...
<div class="row g-2">
<div class="col-6"><button type="button" class="btn btn-primary w-100" name="dosearch" id="dosearch" onclick="javascript:list_submit(-1); return false;">Найти</button></div>
<div class="col-6"><button type="button" class="btn btn-secondary w-100" name="dofullsearch" id="dofullsearch" onclick="javascript:full_submit(1); return false;">Расширенный поиск</button></div>
</div>[/simple-search]
...
<div class="row g-2">
<div class="col-lg-4"><button type="button" class="btn btn-primary w-100" name="dosearch" id="dosearch" onclick="javascript:list_submit(-1); return false;">Искать</button></div>
<div class="col-lg-4"><button type="button" class="btn btn-primary w-100" name="doclear" id="doclear" onclick="javascript:clearform('fullsearch'); return false;">Сбросить</button></div>
<div class="col-lg-4"><button type="reset" class="btn btn-primary w-100" name="doreset" id="doreset">Вернуть</button></div>
</div>
...
[searchmsg]
<div class="alert rounded-2 mb-4 alert-warning py-2 m-0 bg-primary border-0 rounded-0 alert-dismissible fade show text-center overflow-hidden" role="alert">
...
<b class="text-white">Информация!</b><br>
<p class="text-white m-0">{searchmsg}</p>
</div>
