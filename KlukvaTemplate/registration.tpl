<div class="pb-2 mb-4 border-bottom"><h1 class="fs-2">[registration]Регистрация на сайте[/registration][validation]Продолжение регистрации[/validation]</h1></div>

<div class="alert mb-4 rounded-2 alert-warning py-2 m-0 bg-primary border-0 rounded-0 alert-dismissible fade show text-center overflow-hidden" role="alert">
...
<b class="text-white">Уважаемый постетитель нашего сайта!</b><br>
...
<button class="btn btn-primary w-100" name="submit" type="submit">Зарегистрироваться</button>
